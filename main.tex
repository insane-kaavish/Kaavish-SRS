...
*Note: While we are currently inclined towards using \texttt{Heroku} for
deployment as we used it in our previous project and it is easy to use and
scale, we might switch to \texttt{Amazon Web Services} or \texttt{Google Cloud
Platform} depending on the requirements of the project.
...
The justification for using the above-mentioned technologies is as follows:
...
\subsubsection{Description}
\begin{itemize}
      \item \textbf{User:} The user document will contain all the information about the user including the
            user's name, email, password, and the data the user has provided.
      \item \textbf{Record:} The record will be a sub-document of the user document. The record will
            contain all the information about the user's household information
            including the number of people in the household, the size of the
            house, and rooms in the house and the bill history as arrays.
      \item \textbf{Room:} The room will be a sub-document of the record. The room will
            contain all the information about the user's rooms including the
            type of the room, and the appliances in the room as an array.
      \item \textbf{Appliance:} The appliance will be a sub-document of the room. The
            appliance will contain all the information about the user's
            appliances including the type of the appliance, the power of the
            appliance, and the usage hours of the appliance.
      \item \textbf{Bill:} The bill will be a sub-document of the record. The bill will
            contain the information about the user's bill including the
            month of the bill, the units of the bill, and the amount of the
            bill.
\end{itemize}
